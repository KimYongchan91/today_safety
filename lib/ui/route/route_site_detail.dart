              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      children: [
                        const FaIcon(FontAwesomeIcons.userGroup,size: 17,),
                        const SizedBox(height: 10,),
                        Text('${modelSite.userCount}명',style: const TextStyle(fontWeight: FontWeight.bold),),
                      ...
                      child:   const SizedBox(
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 3,),
                            Text('만들기',style: TextStyle(color: Colors.blue),),
